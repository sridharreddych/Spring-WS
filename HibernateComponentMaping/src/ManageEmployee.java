...
public class ManageEmployee {
   ...
   public Integer addEmployee(String fname, String lname, 
      ...
      try{
         tx = session.beginTransaction();
         Employeee employee = new Employeee(fname, lname, salary, address);
   ...
   public void listEmployees( ){
      ...
      try{
         tx = session.beginTransaction();
         List employees = session.createQuery("FROM Employeee").list(); 
         for (Iterator iterator = 
                           employees.iterator(); iterator.hasNext();){
            Employeee employee = (Employeee) iterator.next(); 
   ...
   public void updateEmployee(Integer EmployeeID, int salary ){
      ...
      try{
         tx = session.beginTransaction();
         Employeee employee = 
                    (Employeee)session.get(Employeee.class, EmployeeID); 
